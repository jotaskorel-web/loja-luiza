        ...
        <div class="container-fluid">
            ...
            <div class="max-w-[1722px] mx-auto flex items-start justify-between gap-10 s-pb-100 flex-wrap lg:flex-nowrap footer-wrapper">
                ...
                <div class="lg:max-w-[522px] w-full sm:text-center -order-1 lg:order-none">
                    ...
                    <p class="mt-4 text-white-light max-w-[522px] sm:mx-auto">Loja Luiza is a modern furniture PHP template for an eCommerce website designed to help you create an impressive online store for your furniture. </p>
            ...
            <div class="max-w-[1722px] mx-auto border-t border-white border-opacity-10 py-5 md:py-7 text-center">
                <p class="text-white">© <script>document.write(new Date().getFullYear())</script> Loja Luiza. Develop with <i class="mdi mdi-heart text-red-600"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
            </div>
        </div>
    </div>
</div>
