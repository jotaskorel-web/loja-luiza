...
<html lang="en">
    ...
    <body class="bg-white dark:bg-title">
        ...
        <?php
            // Define mappings for navbar and footer files
            $navbarFiles = [
                'nav' => 'navbar.php',
                'nav1' => 'navbar1.php',
                'nav2' => 'navbar2.php',
            ...
            if (isset($page) && array_key_exists($page, $navbarFiles)) {
                include __DIR__ . '/' . $navbarFiles[$page];
            }

            // Main content
            echo $hero_content ?? '<!-- Default hero content -->';

            // Include footer
            if (isset($fpage) && array_key_exists($fpage, $footerFiles)) {
                include __DIR__ . '/' . $footerFiles[$fpage];
            }
        ?>
        ...
        <script src="<?php echo $static_url; ?>/js/base.js"></script>
