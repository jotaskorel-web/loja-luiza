...
$teams = [
    [
        ...
        'desc' => "Designers de produto criam soluções que unem função, estética e conforto no dia a dia.", 
    ...
    [
        ...
        'name' => 'Jamse Zuan', 
        'title' => "CEO e fundadora", 
        'desc' => "Como líder da Loja Luiza, Emma Wilson cuida da estratégia e do crescimento da empresa.", 
    ...
    [
        ...
        'desc' => "Flacxia Piano cuida das operações do dia a dia e da logística, para que cada pedido siga um fluxo organizado.", 
    ...
    [
        ...
        'name' => 'Luciana Sacchena', 
        'title' => "Fotógrafo", 
        'desc' => "Luciana Sacchena acompanha as operações diárias e garante que os processos aconteçam com fluidez.", 
    ...
    [
        ...
        'desc' => "Como responsável técnico, Nathan cuida para que o site seja rápido, seguro e fácil de usar, com uma experiência de compra fluida.", 
        'class' => "group sm:grid sm:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35]", 
        'data' => "", 
        'span' => "false", 
        'span1' => "true",
    ...
    [
        ...
        'desc' => "Porlo Matiana lidera o time comercial e ajuda cada cliente a encontrar o móvel certo, com atendimento próximo e foco na satisfação.", 
        'class' => "group flex flex-col-reverse sm:grid sm:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35]", 
        'data' => "200", 
        'span' => "true", 
        'span1' => "false",
