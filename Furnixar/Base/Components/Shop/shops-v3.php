...
<div class="group">
    <div class="relative overflow-hidden">
        ...
        <div class="absolute z-10 top-[84%] right-3 transform -translate-y-[40%] opacity-0 duration-300 transition-all group-hover:-translate-y-1/2 group-hover:opacity-100 flex flex-col items-end gap-3">
