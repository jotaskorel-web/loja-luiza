...
<div>
    <div class="group relative overflow-hidden">
        ...
        <div class="absolute w-11/12 h-[91.6666%] top-[96%] left-[96%] transform -translate-x-2/4 -translate-y-2/4 bg-white dark:bg-title bg-opacity-70 dark:bg-opacity-70 flex items-end p-5 scale-110 opacity-0 duration-200 group-hover:scale-100 group-hover:opacity-100">
            ...
            <div class="absolute z-10 top-5 right-5 flex flex-col items-end gap-3">
                <a href="#" class="bg-white dark:bg-title dark:text-white bg-opacity-80 flex items-center justify-center gap-2 px-4 py-[10px] text-base leading-none text-title rounded-[40px] h-14 overflow-hidden new-product-icon new-product-icon-3">
                    ...
                    <span class="mt-1">Adicionar aos favoritos</span>
                </a>
                <a href="#" class="bg-white dark:bg-title dark:text-white bg-opacity-80 flex items-center justify-center gap-2 px-4 py-[10px] text-base leading-none text-title rounded-[40px] h-14 overflow-hidden new-product-icon new-product-icon-3">
                ...
                <button class="bg-white dark:bg-title dark:text-white bg-opacity-80 flex items-center justify-center gap-2 px-4 py-[10px] text-base leading-none text-title rounded-[40px] h-14 overflow-hidden new-product-icon new-product-icon-3 quick-view">
                    ...
                    <span class="mt-1">Visualização rápida</span>
                </button>
            </div>
        </div>
    </div>
    <div class="mt-4 md:mt-6 flex items-start justify-between gap-4">
        ...
        <?php elseif ($item['span'] === 'true'): ?>
            <h5 class="leading-none mb-4 dark:text-white font-primary text-lg font-medium"><?php echo $item['price']; ?><span class="text-title/50 line-through pl-2 inline-block dark:text-white/50">R$ 140,99</span></h5>
        <?php endif; ?>
