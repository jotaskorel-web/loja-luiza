...
<div class="py-16 overflow-hidden relative" data-aos="fade-up">
    <div class="owl-carousel portfolio-v1-slider max-w-md md:max-w-[750px] px-[15px] mx-auto" data-carousel-animateout="false" data-carousel-loop="true">
        ...
        <!-- portfolios-v1 code  -->
        <?php
            include __DIR__ . "/Base/Components/Pages/portfolios-v1.php";
        ?>

    </div>
    <!-- Navigation -->
    <div class="flex justify-between">
        <button class="icon prtflo01_prev w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-title duration-300 bg-white hover:bg-primary hover:text-white p-2 absolute top-[54%] transform -translate-y-1/2 left-0 z-50">
        ...
        <button class="icon prtflo01_next w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-title duration-300 bg-white hover:bg-primary hover:text-white p-2 absolute top-[54%] transform -translate-y-1/2 right-0 z-50">
            <svg class="fill-current" width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
