...
<div class="flex items-center gap-4 flex-wrap bg-overlay p-14 sm:p-16 before:bg-title before:bg-opacity-70" style="background-image:url('<?php echo $static_url; ?>/img/shortcode/breadcumb.jpg');">
    <div class="text-center w-full">
        <h2 class="text-white text-8 md:text-[40px] font-normal leading-none text-center">Meu perfil</h2>
                ...
                <div id="content3" class="bg-[#F8F8F9] dark:bg-dark-secondary p-5 sm:p-8 lg:p-[50px] order-history-table">
                    <ul class="order-history">
                        ...
                        <li class="title flex items-center justify-between gap-5 pb-[10px] sm:pb-5 border-b border-bdr-clr dark:border-bdr-clr-drk">
                            ...
                            <span class="text-lg md:text-xl font-semibold leading-none text-title dark:text-white w-[72px]">Remover</span>
                        </li>
                        <!-- Single Table Row -->
                        <li class="flex items-center justify-between gap-5 py-[15px] sm:py-[15px] border-b border-bdr-clr dark:border-bdr-clr-drk">
                            <div class="flex items-center gap-3 md:gap-4 lg:gap-6 ordered-product w-[270px] sm:w-[310px] xl:w-[330px]">
                                ...
                                <div class="flex-1">
                                    <span class="text-[15px] font-medium leading-none">13 de novembro de 2023</span>
                                    <h5 class="font-semibold leading-none mt-2 md:mt-4"><a href="#">Conjunto de sofá moderno</a></h5>
                                </div>
                            </div>
                        ...
                        <li class="flex items-center justify-between gap-5 py-[15px] sm:py-[15px] border-b border-bdr-clr dark:border-bdr-clr-drk">
                            <div class="flex items-center gap-3 md:gap-4 lg:gap-6 ordered-product w-[270px] sm:w-[310px] xl:w-[330px]">
                                ...
                                <div class="flex-1">
                                    <span class="text-[15px] font-medium leading-none">13 de novembro de 2023</span>
                                    <h5 class="font-semibold leading-none mt-2 md:mt-4"><a href="#">Cadeira clássica com vaso</a></h5>
                                </div>
                            </div>
                        ...
                        <li class="flex items-center justify-between gap-5 py-[15px] sm:py-[15px] border-b border-bdr-clr dark:border-bdr-clr-drk">
                            <div class="flex items-center gap-3 md:gap-4 lg:gap-6 ordered-product w-[270px] sm:w-[310px] xl:w-[330px]">
                                ...
                                <div class="flex-1">
                                    <span class="text-[15px] font-medium leading-none">13 de novembro de 2023</span>
                                    <h5 class="font-semibold leading-none mt-2 md:mt-4"><a href="#">Luminária suspensa de luxo</a></h5>
                                </div>
                            </div>
                        ...
                        <li class="flex items-center justify-between gap-5 py-[15px] sm:py-[15px] border-b border-bdr-clr dark:border-bdr-clr-drk">
                            <div class="flex items-center gap-3 md:gap-4 lg:gap-6 ordered-product w-[270px] sm:w-[310px] xl:w-[330px]">
                                ...
                                <div class="flex-1">
                                    <span class="text-[15px] font-medium leading-none">13 de novembro de 2023</span>
                                    <h5 class="font-semibold leading-none mt-2 md:mt-4"><a href="#">Vaso de qualidade premium</a></h5>
                                </div>
                            </div>
                        ...
                        <li class="flex items-center justify-between gap-5 pt-[15px] sm:pt-[15px] ">
                            <div class="flex items-center gap-3 md:gap-4 lg:gap-6 ordered-product w-[270px] sm:w-[310px] xl:w-[330px]">
                                ...
                                <div class="flex-1">
                                    <span class="text-[15px] font-medium leading-none">13 de novembro de 2023</span>
                                    <h5 class="font-semibold leading-none mt-2 md:mt-4"><a href="#">Cadeira branca clássica</a></h5>
                                </div>
                            </div>
