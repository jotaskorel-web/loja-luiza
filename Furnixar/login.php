...
<div class="flex">
    ...
    <div class="w-full md:w-1/2 lg:max-w-lg xl:max-w-3xl lg:w-full py-16 px-[20px] sm:px-8 lg:p-16 xl:p-24 relative z-10 flex items-center overflow-hidden">
        ...
        <div class="mx-auto md:mx-0 max-w-md">
            <h2 class="leading-none text-4xl font-bold" data-aos="fade-up">Que bom te ver de novo!</h2>
            ...
            <div data-aos="fade-up" data-aos-delay="500">
                <a href="#" class="btn btn-theme-solid mt-[15px]" data-text="Entrar"><span>Entrar</span></a>
            </div>
            <p class="text-lg mt-[15px]" data-aos="fade-up" data-aos-delay="600">Ainda não tem uma conta? <a href="register.php" class="text-primary font-medium ml-1 inline-block">Cadastrar</a></p>
        </div>
    </div>
</div>
